                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <form class="form-horizontal" method="POST">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="cc" id="inputPassword" value = "<?php echo isset($cys) ? $cys : '' ?>" placeholder="Course Code" required>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            if(empty($_POST['id']))
                                            mysqli_query($conn,"insert into course (cys,department) values ('$cc','$cd')") or die(mysqli_error());
                                            else
                                            mysqli_query($conn,"UPDATE course set cys = '$cc',department ='$cd'  where course_id = {$_POST['id']}") or die(mysqli_error());
