                        ...
                        <div class="hero-unit-3">
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="em" id="inputEmail" placeholder="email" required value="<?php echo isset($email) ? $email : "" ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if(empty($_POST['id']))
                                mysqli_query($conn,"insert into student (email,password,firstname,lastname,middle_name,location)
                                    values ('$em','$p','$fn','$ln','$mn','$location')                                    
                                    ") or die(mysqli_error());
                                else{
                                    if(!empty($p)){
                                        $pw = " , password='$p' ";
