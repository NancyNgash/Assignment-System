                    ...
                    <div class="span12">
                        <div class="hero-unit-3">
                            ...
                            if (isset($_POST['save'])) {
                                ...
                                mysqli_query($conn,"insert into teacher (email,password,firstname,lastname,middlename,department,location)
                        values ('$email','$password','$firstname','$lastname','$middlename','$department','$location')         
") or die(mysqli_error());
