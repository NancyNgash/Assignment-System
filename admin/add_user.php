                                ...
                                <div class="thumbnail">
                                    ...
                                    <form class="form-horizontal" method="POST">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="email" name="em" id="inputEmail" placeholder="Email" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                    ...
                                    if (isset($_POST['save'])) {
                                        ...
                                        mysqli_query($conn,"insert into users (email,password,firstname,lastname) values ('$em','$p','$fn','$ln')")or die(mysqli_error());
