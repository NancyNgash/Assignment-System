                        ...
                        <div class="hero-unit-3">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="email" id="inputEmail" name="email" value="<?php echo $row['email']; ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">
                            ...
                            if (isset($_POST['save'])) {
                    			...
                    			mysqli_query($conn,"update teacher set email='$email',password='$password',firstname='$firstname',lastname='$lastname',middlename='$middlename',
